...
const ConnectionGuide = () => {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      items: [
        "Нажмите «Активировать eSIM»",
        "Откройте QR на другом экране для сканирования",
      ],
      note: "QR также придёт на email",
      noteType: "info",
    },
    {
      icon: ScanLine,
      title: "Шаг 1. Отсканируйте QR",
      items: [
        "Наведите камеру на QR и перейдите по ссылке",
    ...
    },
    {
      ...
      items: [
        "«Подтвердить» / «Добавить тарифный план»",
        "Дождитесь загрузки профиля (1–2 мин)",
      ],
    },
    {
      icon: Smartphone,
    ...
    {
      icon: ShieldCheck,
      title: "Шаг 4. Верификация (только РФ)",
      items: [
    ...
    {
      icon: Wifi,
      title: "Шаг 5. Проверьте подключение",
      items: [
        "Откройте любой сайт",
