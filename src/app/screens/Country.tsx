            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="w-[18px] h-[18px] flex items-center justify-center text-white/90">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.5 14.5h-2.1l-3.9-6.3v6.3H8.5V7.5h2.1l3.9 6.3V7.5h1.9v9z" />
                    </svg>
                  </span>
                  <span className="w-[18px] h-[18px] flex items-center justify-center text-white/90">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                      <path d="M12.525.02c1.8-.1 3.74.143 5.327.566h.003s-1.847 2.146-1.847 2.146a6.62 6.62 0 0 0-3.58-.522c-3.676.4-6.376 3.704-6.376 7.41v.018c0 3.706 2.7 7.01 6.376 7.41a6.62 6.62 0 0 0 3.58-.522s1.847 2.146 1.847 2.146h-.003A9.88 9.88 0 0 1 12.525 24c-6.466 0-11.72-5.253-11.72-11.72S6.059.02 12.525.02zm8.352 4.326a9.89 9.89 0 0 1 2.643 6.674c0 2.54-.957 4.86-2.525 6.614h-.003s-1.847-2.146-1.847-2.146a6.62 6.62 0 0 0 1.98-4.468v-.018a6.62 6.62 0 0 0-1.98-4.468s1.847-2.146 1.847-2.146h.003l-.118.084z" />
                    </svg>
                  </span>
                </div>
              </div>
