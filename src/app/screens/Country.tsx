...
// Per-plan pastel icon tile colors, matching the mockup.
    ...
    return (
      <PhoneFrame>
        <div className="bg-white">
          <StatusBar />
          <div className="px-4 pb-4 pt-1 text-foreground">Страна не найдена</div>
        </div>
      ...
      <div className="bg-white border-b border-border/60">
        ...
        <div className="relative h-14 flex items-center px-2">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
            ...
            <span className="text-[19px] font-bold text-foreground">{country.name}</span>
          </div>
        </div>
      </div>
