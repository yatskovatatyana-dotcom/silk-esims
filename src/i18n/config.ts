  ...
  ru: {
    translation: {
      ...
      "howItWorks": {
        ...
        "subtitle": "Тарифные под любые жизненные сценарии",
        "steps": {
          "choose": {
          ...
          "activate": {
            ...
            "description": "Отсканируйте QR-код, включите мобильный интернет Silk eSIM и вперёд"
          }
        }
      },
      "pricing": {
      ...
      "cta": {
        "title": "Готовы забыть об ограничениях?",
        "subtitle": "Присоединяйтесь к тысячам пользователей,\nкоторые уже перешли с VPN на Silk eSIM",
