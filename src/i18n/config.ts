      ...
      "connectionGuide": {
        ...
        "steps": {
          "compatibility": {
            ...
            "iosPath": "Настройки → Сотовая связь",
            "androidPath": "Настройки → Сеть → SIM-карты",
            "descSuffix": "Если видишь опцию добавить eSIM — твоё устройство совместимо."
          },
          "buy": {
          ...
          "activate": {
            ...
            "description": "После оплаты в меню бота появится купленный пакет. Активируй его нажав кнопку «Старт»."
          },
          "qr": {
            "title": "Получи QR-код",
            "description": "После покупки в бот (кнопка Показать QR) и на почту придёт QR-код для установки eSIM. Открой его с другого устройства, чтобы можно было отсканировать телефоном."
          },
          "install": {
            "title": "Установи eSIM",
          ...
          "enable": {
            ...
            "warning2": "Включи мобильные данные и роуминг данных на установленной eSIM."
          },
          "captcha": {
            "title": "Пройди авторизацию по ссылке от оператора",
            "description": "Придет SMS о прибытии в РФ. Значит все корректно! Вы подключитесь либо к сети Билайн либо к Tele2. По ссылке из смс необходимо пройти авторизацию.",
            "links": "Прямые ссылки на авторизацию сим карты, если смс не пришла:"
          },
          "ready": {
