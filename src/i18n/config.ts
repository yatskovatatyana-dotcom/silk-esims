      ...
      "connectionGuide": {
        ...
        "steps": {
          ...
          "captcha": {
            ...
            "description": "Придет SMS о прибытии в РФ. Значит все корректно! Вы подключитесь либо к сети Билайн либо к Tele2. По ссылке из смс необходимо пройти авторизацию. Прямые ссылки на авторизацию сим карты: balance.beeline.ru/guest/ или t2.ru/dostup если смс не пришла."
          },
          "ready": {
