    ...
    translation: {
      ...
      "connectionGuide": {
        ...
        "steps": {
          ...
          "install": {
            "title": "Установи eSIM. Делается 1 раз, далее просто докупаются пакеты для разных стран",
            "ios": {
              "title": "iPhone (iOS)",
          ...
          "captcha": {
            ...
            "description": "Придет SMS на английском языке от российского оператора связи о прибытии в Россию и подключении роуминга. Значит все установилось корректно! По ссылке необходимо пройти каптчу для обхода 24-часового охлаждающего периода. Готово!"
          },
          "ready": {
