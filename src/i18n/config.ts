      ...
      "connectionGuide": {
        ...
        "steps": {
          ...
          "activate": {
            ...
            "description": "В личном кабинете в боте или на сайте активируйте купленный пакет нажав кнопку"
          },
          "qr": {
            "title": "Получи QR-код после покупки пакета",
            "description": "На почту и в бот придёт QR-код.\nОткрой его с другого устройства, чтобы можно было отсканировать телефоном."
          },
          "install": {
            "title": "Установи eSIM",
          ...
          "enable": {
            "title": "Зайди в Настройки → Сотовая связь",
            "subtitle": "Выстави настройки как указано ниже",
